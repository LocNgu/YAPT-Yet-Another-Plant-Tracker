...
- **Check-in reminders** — A watering-due reminder is titled "Check {plant}" with three actions: **Watered**, **Still moist** (records the watering as too-soon without logging anything), and **Not now** (pushes the due date back a day)
