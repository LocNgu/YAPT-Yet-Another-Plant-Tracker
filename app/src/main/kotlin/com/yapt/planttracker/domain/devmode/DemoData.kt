 ...
 * bootstrap for free — every other plant keeps `wateringConfidence == null`, so the next WATER log
 * against a plant with enough history (Monstera, Snake Plant, Fiddle Leaf Fig, Pothos, Peace Lily)
 * triggers `bootstrapBaseInterval()`, while the sparse-history plants (Aloe Vera, Cactus, Calathea)
