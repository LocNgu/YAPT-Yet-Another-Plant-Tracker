...
- BackupManager: export with photos to cloud SAF destinations (e.g. Google Drive) no longer produces a broken 0 KB ZIP; the full ZIP is now written to a local temp file first, then streamed to the destination URI in a single copy (#144)
