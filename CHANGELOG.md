...
### Added
- Settings → Display: new **Theme** option to choose **System default** (follows the device, the previous behaviour and the default), **Light**, or **Dark**. The choice persists across launches and applies app-wide immediately (#139)
