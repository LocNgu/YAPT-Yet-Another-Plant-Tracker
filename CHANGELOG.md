...
### Changed
- **Adaptive watering now uses one observation path for quick logging and the Add Care Log form** — dormancy, bootstrap, confidence, and adjustment rules are shared so fixes apply consistently to both entry points. No intended user-visible behavior change (#780, technical ADR-0030)
