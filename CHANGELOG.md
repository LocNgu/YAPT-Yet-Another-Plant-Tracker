...
### Added
- **Drain-water reminder after watering** — recording a watering now schedules one standing-water reminder 30 minutes after the latest plant in the watering round, including bulk watering and liquid-fertilizer paired waterings. The reminder is generic, opens Plants filtered to "Cared for today" without changing the saved sort, skips backdated/edited/duplicate-suppressed logs, and has a default-on Settings → Reminders toggle that round-trips through backup schema v15 (#519)
### Changed
