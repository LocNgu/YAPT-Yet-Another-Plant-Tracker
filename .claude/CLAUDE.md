...
- Backup schema v7: `BackupPlant.mistingIntervalDays`/`repottingIntervalDays: Int? = null` round-trip the extended-care reminder intervals; old v6-and-earlier backups deserialize both to `null` via the field defaults (#232)
