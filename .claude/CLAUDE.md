...
- **Seasonal fertilizing** (#286, product ADR-0045) — four nullable manual Spring/Summer/Autumn/Winter slots use the same timezone-derived hemisphere as seasonal watering and fall back individually to `fertilizingIntervalDays`. They never learn or write adjustment history. The first-fertilize grace path ignores slots, and dormancy is the only pause mechanism.
