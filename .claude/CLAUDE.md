...
- **Dormant watering cadence** (#785, product ADR-0046) — a valid dormancy window may opt into a fixed 28/35/42-day watering cadence; null keeps full suspension. The cadence ignores seasonal/adaptive state, while fertilizing stays suspended and dormancy-spanning waterings remain excluded from learning and reason prompts.
