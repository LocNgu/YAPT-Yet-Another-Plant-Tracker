...
- **Dormancy display** (#763/#286, product ADR-0044/product ADR-0049) — `PlantCareStatus.isDormant` marks suspended watering and fertilizing schedules. Plant List watering/fertilizing due groupings and the watering chip say Dormant; Calendar shows dormant plants separately on today without counting them as due and suppresses both care dates inside the window. "Why this date?" shows suspension in place of a live watering due date, while adjustment history remains visible.
