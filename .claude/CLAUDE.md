...
- **Dormancy display** (#763, product ADR-0044) — `PlantCareStatus.isDormant` marks a suspended watering schedule. Plant List watering due groupings and the watering chip say Dormant; Calendar shows dormant plants separately on today without counting them as due and suppresses watering dates inside the window. Fertilizing remains scheduled. "Why this date?" shows suspension in place of a live due date, while adjustment history remains visible.
